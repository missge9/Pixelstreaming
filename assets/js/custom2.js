...
(function ($) {
    ...
    $.each(json,function(index,item){
        ...
        if (item.Status == 1) {
            ...
            var verkauftLabel = $(`<div class="verkauft-label">${item.StatusText}</div>`);
    ...
    $("#homePage").on("click",function(){
        ...
        document.getElementById('iframe360').onload = function() {
            setTimeout(function() {
                var iframe = document.getElementById('iframe360');
            ...
            }, 500); // 1000 Millisekunden entsprechen 1 Sekunde
        };
