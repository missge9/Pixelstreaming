 ...
 */
function SendToUE(attribute) {
    console.log("Successful sendet to Unreal: " + attribute);
}
...
function connect() {
    ...
    var  url = "https://realitystream.dvdarch.ch";
    let connectionUrl = url.replace('http://', 'ws://').replace('https://', 'wss://'); //window.location.href.replace('http://', 'ws://').replace('https://', 'wss://');
